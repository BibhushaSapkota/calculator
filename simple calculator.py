...
button_0=Button(root, text='0', padx=40,pady=20, command=lambda : button_click(0)).grid(row=4, column=2)
button_add=Button(root,text='+',padx=40,pady=20,command=button_add).grid(row=4, column=0)
...
button_clear=Button(root,text='clear',padx=89,pady=20,command=button_clear).grid(row=6, column=1,columnspan=2)
